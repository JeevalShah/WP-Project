        ...
        <header class="border-b border-gray-200 bg-white">
            <div class="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <nav class="hidden md:flex space-x-8">
                    <a href="/" class="text-gray-800 hover:text-mint-green transition">Home</a>
                    <a href="/products" class="text-gray-800 hover:text-mint-green transition">Products</a>
                    <a href="/about" class="text-gray-800 hover:text-mint-green transition">About</a>
        ...
        <div class="py-12 bg-gray-50">
            <div class="container mx-auto px-4">
                ...
                <div id="emptyCart" class="text-center py-12" style="display: none;">
                    ...
                    <a 
                        href="/products" 
                        class="inline-block px-6 py-3 bg-mint-green text-white font-medium rounded-full hover:bg-sky-blue transition"
                    >
                        Continue Shopping
                    </a>
                </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="lg:w-2/3">
                            ...
                            <div class="mt-6 flex justify-between items-center">
                                <a 
                                    href="/products" 
                                    class="inline-flex items-center text-sky-blue font-medium hover:text-sky-blue transition"
                                >
                                    <i class="fas fa-arrow-left mr-2"></i>
                                    Continue Shopping
                                </a>
                                <button 
                                    class="px-6 py-2 bg-mint-green text-white font-medium rounded-full hover:bg-sky-blue transition"
                                    id="updateCart"
                                >
                                    Update Cart
                                </button>
                            ...
                            <div class="bg-white rounded-lg shadow-sm p-6">
                                ...
                                <div class="border-t border-b border-gray-200 py-4 space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium" id="shippingFee">₹100</span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="flex">
                                        <input 
                                            ...
                                            id="promoCode"
                                        />
                                        <button class="bg-gray-200 text-gray-800 px-4 py-2 rounded-r-lg hover:bg-gray-300 transition" id="applyPromo">
                                            Apply
                                        </button>
                                    </div>
                                </div>
